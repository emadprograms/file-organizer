...
(function() {
    ...
    function renderHouseProfile(profile) {
        ...
        tenantsHeader.innerHTML = `
            ...
            <span class="min-w-[20px] h-5 px-1.5 inline-flex items-center justify-center text-[11px] font-bold text-slate-600 bg-slate-100 border border-slate-200 rounded-full font-mono">
                        ...
                        <div class="flex items-center gap-2.5 min-w-0 flex-1">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <div class="flex items-center gap-2 mt-1 text-[11px] text-slate-500 flex-wrap">
                                    <span class="font-mono text-slate-500">${cleanDuration}</span>
