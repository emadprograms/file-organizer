...
**Verification depth scales with `asvs_level`** (see @C:/Users/Emad/Documents/GitHub/file-organizer/.gemini/gsd-core/references/security-asvs-levels.md for full definitions):
