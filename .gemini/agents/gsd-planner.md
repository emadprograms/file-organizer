...
@C:/Users/Emad/Documents/GitHub/file-organizer/.gemini/gsd-core/references/mandatory-initial-read.md
...
**Project skills:** @C:/Users/Emad/Documents/GitHub/file-organizer/.gemini/gsd-core/references/project-skills-discovery.md
...
@C:/Users/Emad/Documents/GitHub/file-organizer/.gemini/gsd-core/references/planner-source-audit.md for full format, examples, and gap-handling rules.
...
@C:/Users/Emad/Documents/GitHub/file-organizer/.gemini/gsd-core/references/planner-source-audit.md for constraint examples.
...
See @C:/Users/Emad/Documents/GitHub/file-organizer/.gemini/gsd-core/references/planner-guidance.md for planning philosophy (Solo Developer workflow, Plans Are Prompts, Quality Degradation Curve, Ship Fast).
...
See @C:/Users/Emad/Documents/GitHub/file-organizer/.gemini/gsd-core/references/planner-guidance.md for Task Types table, Task Sizing rules, Interface-First Task Ordering, and Specificity guidance.

## TDD Detection

**When `workflow.tdd_mode` is enabled:** Apply TDD heuristics aggressively — all eligible tasks MUST use `type: tdd`. Read @C:/Users/Emad/Documents/GitHub/file-organizer/.gemini/gsd-core/references/tdd.md for gate enforcement rules and the end-of-phase review checkpoint format.
...
**When `MVP_MODE` is enabled (passed by the plan-phase orchestrator):** Decompose tasks as **vertical feature slices**, not horizontal layers. Required reading: Read `C:/Users/Emad/Documents/GitHub/file-organizer/.gemini/gsd-core/references/planner-mvp-mode.md` for the vertical-slice rules (lazy — only on MVP runs).
...
1. Frame the phase goal as a user story at the top of `PLAN.md`. The user story is sourced from the `**Goal:**` line in ROADMAP.md (set by `mvp-phase`). Emit it with bolded keywords:
   ...
   **As a** [user role], **I want to** [capability], **so that** [outcome].
   ...
   Format rules (Read `C:/Users/Emad/Documents/GitHub/file-organizer/.gemini/gsd-core/references/user-story-template.md`):
...
See @C:/Users/Emad/Documents/GitHub/file-organizer/.gemini/gsd-core/references/planner-guidance.md for User Setup Detection protocol (external service indicators, env vars, dashboard config).

</task_breakdown>

<dependency_graph>

See @C:/Users/Emad/Documents/GitHub/file-organizer/.gemini/gsd-core/references/planner-guidance.md for dependency graph building rules and file ownership for parallel execution.
...
See @C:/Users/Emad/Documents/GitHub/file-organizer/.gemini/gsd-core/references/planner-guidance.md for Granularity Calibration table (Coarse/Standard/Fine plans-per-phase).
...
See @C:/Users/Emad/Documents/GitHub/file-organizer/.gemini/gsd-core/references/planner-guidance.md for a worked example and the `must_haves` YAML format.
...
@C:/Users/Emad/Documents/GitHub/file-organizer/.gemini/gsd-core/references/planner-antipatterns.md
...
@C:/Users/Emad/Documents/GitHub/file-organizer/.gemini/gsd-core/references/thinking-models-planning.md
...
See @C:/Users/Emad/Documents/GitHub/file-organizer/.gemini/gsd-core/references/planner-guidance.md for `## PLANNING COMPLETE` and `## GAP CLOSURE PLANS CREATED` return format templates.

See @C:/Users/Emad/Documents/GitHub/file-organizer/.gemini/gsd-core/references/planner-chunked.md for `## OUTLINE COMPLETE` and `## PLAN COMPLETE` return formats used in chunked mode.
