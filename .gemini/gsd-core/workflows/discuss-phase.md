...
<required_reading>
@C:/Users/Emad/Documents/GitHub/file-organizer/.gemini/gsd-core/references/domain-probes.md
@C:/Users/Emad/Documents/GitHub/file-organizer/.gemini/gsd-core/references/gate-prompts.md
@C:/Users/Emad/Documents/GitHub/file-organizer/.gemini/gsd-core/references/universal-anti-patterns.md
</required_reading>
...
if [ -f "C:/Users/Emad/Documents/GitHub/file-organizer/.gemini/gsd-core/USER-PROFILE.md" ]; then
  ADVISOR_MODE=true
else
  ADVISOR_MODE=false
fi
...
Read `@C:/Users/Emad/Documents/GitHub/file-organizer/.gemini/gsd-core/references/scout-codebase.md` — it contains the phase-type→map selection table, single-read rule, no-maps fallback, and `<codebase_context>` output schema. Then execute:
...
```
Apply each entry in `activeHooks` per @C:/Users/Emad/Documents/GitHub/file-organizer/.gemini/gsd-core/references/loop-hook-dispatch.md. Empty list → continue to `analyze_phase`.
</step>
...
```
Apply each entry in `activeHooks` per @C:/Users/Emad/Documents/GitHub/file-organizer/.gemini/gsd-core/references/loop-hook-dispatch.md. Empty list → continue to `confirm_creation`.
</step>
