...
**Verification depth scales with `asvs_level`** (see @/Users/emadarshadalam/Documents/GitHub/file-organizer/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
