...
INSTALL_JS_GLOBAL="/Users/emadarshadalam/Documents/GitHub/file-organizer/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/emadarshadalam/Documents/GitHub/file-organizer/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
