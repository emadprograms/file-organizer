...
INSTALL_JS_GLOBAL="C:/Users/Emad/Documents/GitHub/file-organizer/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Users/Emad/Documents/GitHub/file-organizer/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
