...
```
Agent(
  prompt="Read /Users/emadarshadalam/Documents/GitHub/file-organizer/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/emadarshadalam/Documents/GitHub/file-organizer/.claude/gsd-core/templates/SECURITY.md`
