...
@C:/Users/Emad/Documents/GitHub/file-organizer/.claude/gsd-core/references/agent-contracts.md
@C:/Users/Emad/Documents/GitHub/file-organizer/.claude/gsd-core/references/context-budget.md
@C:/Users/Emad/Documents/GitHub/file-organizer/.claude/gsd-core/references/gates.md
</required_reading>
...
- Executor agents omit extended deviation rule examples and checkpoint examples from inline prompt — load on-demand via @C:/Users/Emad/Documents/GitHub/file-organizer/.claude/gsd-core/references/executor-examples.md
- Planner agents omit extended anti-pattern lists and specificity examples from inline prompt — load on-demand via @C:/Users/Emad/Documents/GitHub/file-organizer/.claude/gsd-core/references/planner-antipatterns.md
...
```
Pure doc-only / config-only / test-only tasks return `is_behavior_adding=false` and are exempt. When the gate trips, Read `C:/Users/Emad/Documents/GitHub/file-organizer/.claude/gsd-core/references/execute-mvp-tdd.md` for the exact halt report format.
</step>
...
2. For each plan (sequentially, ignoring wave grouping):
   ...
   c. **If "Execute":** Read and follow `C:/Users/Emad/Documents/GitHub/file-organizer/.claude/gsd-core/workflows/execute-plan.md` **inline**
...
@C:/Users/Emad/Documents/GitHub/file-organizer/.claude/gsd-core/references/execute-phase-wave-guard.md

@C:/Users/Emad/Documents/GitHub/file-organizer/.claude/gsd-core/references/execute-phase-context-guard.md
   ...
   **Sequential dispatch for parallel execution (waves with 2+ agents):**
   ...
   Agent(
     ...
     prompt="
       ...
       @C:/Users/Emad/Documents/GitHub/file-organizer/.claude/gsd-core/references/checkpoints.md
       @C:/Users/Emad/Documents/GitHub/file-organizer/.claude/gsd-core/references/tdd.md
       @C:/Users/Emad/Documents/GitHub/file-organizer/.claude/gsd-core/references/worktree-path-safety.md
       ${CONTEXT_WINDOW < 200000 ? '' : '@C:/Users/Emad/Documents/GitHub/file-organizer/.claude/gsd-core/references/executor-examples.md'}
       </execution_context>
...
@C:/Users/Emad/Documents/GitHub/file-organizer/.claude/gsd-core/references/execute-phase-between-wave-reset.md
...
Read and follow `C:/Users/Emad/Documents/GitHub/file-organizer/.claude/gsd-core/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
