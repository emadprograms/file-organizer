...
ones). Reference: @/Users/emadarshadalam/Documents/GitHub/file-organizer/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/emadarshadalam/Documents/GitHub/file-organizer/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/emadarshadalam/Documents/GitHub/file-organizer/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/emadarshadalam/Documents/GitHub/file-organizer/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/emadarshadalam/Documents/GitHub/file-organizer/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/emadarshadalam/Documents/GitHub/file-organizer/.claude/gsd-core/templates/spec.md.
