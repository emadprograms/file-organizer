...
```
Agent(
  prompt="Read C:/Users/Emad/Documents/GitHub/file-organizer/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Emad/Documents/GitHub/file-organizer/.claude/gsd-core/templates/VALIDATION.md`
