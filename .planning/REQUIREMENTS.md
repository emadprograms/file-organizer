...
## 6. Tenant Root Folder Renaming (REQ-06)
...
## 7. Shortcut Target Hijack / Corruption (REQ-07)
...
## 8. Idempotency Guarantee (REQ-08)
...
## 9. File Locking Resilience (REQ-09)
