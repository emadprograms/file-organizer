...
- [ ] **GRP-01**: Decrease grouping chunk sizes to [5, 3, 2] and set consecutive failures limit to 3. [Mapped to Phase 10]
- [ ] **GRP-02**: Ensure the chunk size index is properly reset to 0 upon processing a successful chunk. [Mapped to Phase 10]
