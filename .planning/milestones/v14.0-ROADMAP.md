...
- [x] Quick Refinement QCK-23: Category Badge in Document Viewer Header replacing misplaced Tenant Selector stubs — completed 2026-09-11
- [x] Quick Refinement QCK-24: Vertical Scrollbar in House Card when > 3 Tenancies Exist — completed 2026-09-12
- [x] Quick Refinement QCK-25: Search Tenant Timeline Color Coding & Cross-Language Phonetic Matching — completed 2026-09-12
- [x] Quick Refinement QCK-26: Phonetic Consonant Skeleton Isolation & Strict Cross-Language Name Precision (`usman` <-> `عثمان`) — completed 2026-09-12
- [x] Quick Refinement QCK-27: Decouple Single Document Move/Copy from Multi-Select Batch Selection State — completed 2026-09-12
- [x] Quick Refinement QCK-28: Preserve Open Category Folders & Scroll Offset Across Document Moves & Re-renders — completed 2026-09-12
- [x] Quick Refinement QCK-29: Database-Wide Real-World Name Validation & Phonetic Precision across 716 production tenants — completed 2026-09-12
- [x] Quick Refinement QCK-30: Arabic Search Optimization & Orthographic Normalization (Tashkeel, Tatweel, Alef variants) — completed 2026-09-12
- [x] Quick Refinement QCK-31: Zero-Motion & Zero-State-Shift Document Move & Copy Architecture — completed 2026-09-12
- [x] Quick Refinement QCK-32: Dynamic Category Folder Lifecycle on Move/Copy (Empty card removal & new folder insertion) — completed 2026-09-12
- [x] Quick Refinement QCK-33: Comprehensive Dark Mode Support & Theme Toggle (`Shift+D`, `theme-manager.js`) — completed 2026-09-12
- [x] Quick Refinement QCK-34: Touchscreen & Mobile Protection: Touch-Immune Opening, Double-Click Rename Suppression & Mobile Canvas PDF Viewer — completed 2026-09-12
- [x] Quick Refinement QCK-35: Touch Press-and-Hold Drag-and-Drop Document Move on Tablets (Haptic feedback & floating avatar) — completed 2026-09-12
- [x] Quick Refinement QCK-36: Default Move Tenant to Open Folder, 3-Dots Pin/Unpin Toggle, and Timeline Show in Categories Navigation — completed 2026-09-12
- [x] Quick Refinement QCK-37: Multi-Select Drag and Drop for Tablets & Desktop Computers — completed 2026-09-12
- [x] Quick Refinement QCK-38: Vacant House Grey Styling & False Active Tenant Fallback Removal — completed 2026-09-12
- [x] Quick Refinement QCK-39: Instant Cross-Tenant Document Move & Folder Lifecycle — completed 2026-09-12
- [x] Quick Refinement QCK-40: Vacated Tenant Document Date Conflict & Tenancy Extension Prompt — completed 2026-09-12
- [x] Quick Refinement QCK-41: Past Tenants Chronological Sorting by Vacate Date (`end_date DESC`, `start_date DESC`) — completed 2026-09-12
- [x] Quick Refinement QCK-42: Header Bar Tenure Legend `Vacant` Indicator & Full Dark Mode Support — completed 2026-09-12
