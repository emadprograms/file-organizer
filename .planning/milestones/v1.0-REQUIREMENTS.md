...
- [x] **CLN-01**: Identify and remove unreachable legacy code by tracing imports from the entry point (`src/main.py`).

### Refactoring

- [x] **REF-01**: Refactor `src/cleaning.py` into separate focused modules based on responsibility.
