...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|-------------|--------|
| 02-01-01 | 01 | 1 | REQ-XX | — | N/A | unit | `pytest tests/` | ⬜ pending | ⬜ pending |
...
- [ ] `tests/test_cleaning.py` — stubs for testing the cleaning logic
- [ ] `tests/conftest.py` — shared fixtures for `PageData` and `Tenant` mock data
