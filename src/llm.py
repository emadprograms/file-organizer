...
1. basic_details — البيانات الأساسية (Strictly forms about the person. If the page is a FORM with boxes, tables, or fill-in-the-blanks for a person's name/ID/details, you MUST choose basic_details. FORMS ARE NEVER amar_takhsees. WARNING: If the form/table mentions financial amounts like "30" or "60" for rent deduction, it is NEVER basic_details, it MUST be rent_deduction.)
