...
- **Offline English Translation Overlay**: Enables non-Arabic readers to view translated document intelligence directly overlaid on top of the original scanned PDF canvas. Requires no cloud API keys, translation subscriptions, or external network requests. Powered by locally indexed page metadata and administrative dictionary translation rules with interactive Peek Scan support.
