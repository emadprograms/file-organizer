...
def test_validate_bounds_normal() -> None:
    """
    Test validate bounds normal.
...
def test_validate_bounds_out_of_bounds() -> None:
    """
    Test validate bounds out of bounds.
...
def test_validate_bounds_edge_cases() -> None:
    """
    Test validate bounds edge cases.
